...
<head>
    ...
    <meta name="description" content="API Sekolah di Bekasi">
...
<body>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="#endpoint">End Point</a></li>
                <li class="menu-item hidden"><a href="https://fazarrr.github.io/" target="__blank">Developer</a>
                </li>
            </ul>
        </div>
        ...
        <div class="heroe">
            ...
            <h1>Welcome to RestFul API Sekolah Bekasi</h1>

            <h2>**Untuk saat ini fitur JWT sedang di nonaktifkan karena belum tersedia User Interface untuk getToken</h2>
    ...
    <section id="about">
        ...
        <pre><code>__test=c70002c6f98721dadb6bb01fc016b7c1;expires=Monday, September 25, 2023 at 5:49:16 PM;path=/</code></pre>

    </section>

    <div class="further" id="endpoint">
        ...
        <section>
            ...
            <ul>
                <li>
                    <p>List id_kecamatan, nama_kecamatan & id_kelurahan, nama_kelurahan. Untuk kebutuhan create data SMA.</p>
                    <pre><code>'sma'</code></pre>
                </li>
                <li>
                    <p>List Nama SMA di Bekasi dan telah tersedia pagination dengan limit 20 per page dan tanpa parameter default page 1.</p>
                    <pre><code>'sma/getalldata/{$page}'</code></pre>
                </li>
                <li>
                    <p>Detail SMA di Bekasi.</p>
                    <pre><code>'sma/show/{$id_sma}'</code></pre>
                </li>
                <li>
                    <p>Tambah data SMA di Bekasi.</p>
                    <pre><code>'sma/create'</code></pre>
                    <ul>
                        <p>Parameter :</p>
                        <ol>
                            'id_kecamatan'
            ...
            <ul>
                <li>
                    <p>List id_kecamatan, nama_kecamatan & id_kelurahan, nama_kelurahan. Untuk kebutuhan create data SMK.</p>
                    <pre><code>'smk'</code></pre>
                </li>
                <li>
                    <p>List Nama SMK di Bekasi dan telah tersedia pagination dengan limit 20 per page dan tanpa parameter default page 1.</p>
                    <pre><code>'smk/getalldata/{$page}'</code></pre>
                </li>
                <li>
                    <p>Detail SMK di Bekasi.</p>
                    <pre><code>'smk/show/{$id_smk}'</code></pre>
                </li>
                <li>
                    <p>Tambah data SMK di Bekasi.</p>
                    <pre><code>'smk/create'</code></pre>
                    <ul>
                        <p>Parameter :</p>
                        <ol>
                            'id_kecamatan'
            ...
            <h2>
                ...
                - Nama Kecamatan di Bekasi
            </h2>
            <ul>
                <li>
                    <p>List Nama Kecamatan di Bekasi dan telah tersedia pagination dengan limit 20 per page dan tanpa parameter default page 1.</p>
                    <pre><code>'kecamatan/getalldata/{$page}'</code></pre>
                </li>
                <li>
                    <p>Detail Kecamatan di Bekasi.</p>
                    <pre><code>'kecamatan/show/{$id_kecamatan}'</code></pre>
                </li>
                <li>
                    <p>Tambah data Kecamatan di Bekasi.</p>
                    <pre><code>'kecamatan/create'</code></pre>
                    <ul>
                        <p>Parameter :</p>
                        <ol>
                            'kode_kecamatan'
            ...
            <h2>
                ...
                - Nama Kelurahan di Bekasi
            </h2>
            <ul>
                <li>
                    <p>List Nama Kelurahan di Bekasi dan telah tersedia pagination dengan limit 20 per page dan tanpa parameter default page 1.</p>
                    <pre><code>'kelurahan/getalldata/{$page}'</code></pre>
                </li>
                <li>
                    <p>Detail Kelurahan di Bekasi.</p>
                    <pre><code>'kelurahan/show/{$id_kelurahan}'</code></pre>
                </li>
                <li>
                    <p>Tambah data Kelurahan di Bekasi.</p>
                    <pre><code>'kelurahan/create'</code></pre>
                    <ul>
                        <p>Parameter :</p>
                        <ol>
                            'kode_kelurahan'
